...
# Configuration
$SOURCE_DIR = "H:\WebHatchery\game_apps\kemo_sim"
...
$DEST_DIR = Join-Path $DEST_ROOT "kemo_sim"
...
function Build-Frontend {
    ...
    # Set base path for preview environment (kemo_sim subdirectory)
    if ($Environment -eq 'preview') {
        Write-Info "Setting base path for preview environment..."
        $env:VITE_BASE_PATH = "/kemo_sim/"
...
# Main execution
function Main {
    Write-Info "kemo_sim Publishing Script"
    Write-Info "=========================="
...
DESCRIPTION:
    This script builds and publishes the kemo_sim god simulation game to either the 
