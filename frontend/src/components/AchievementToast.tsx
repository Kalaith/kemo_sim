...
export default function AchievementToast() {
  ...
  useEffect(() => {
    const unlockedAchievement = achievements.find(a => 
      a.unlocked && a.unlockedDate && 
      Date.now() - new Date(a.unlockedDate).getTime() < 5000 // Within last 5 seconds
    );
  ...
  return (
    <div className="fixed top-6 right-6 z-50 animate-slide-in">
      <div className="text-white px-6 py-4 rounded-xl shadow-2xl max-w-sm border-2" style={{
